  ...
  _createClass(Interface, [{
    ...
    value: function buildBar() {
      return (0, _redom.el)('section#cconsent-bar.ccb--hidden', (0, _redom.el)("a.close.m-3.consent-refuse", {
        href: '#',
        tabindex: 0,
        title: _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'barBtnRefuseAll')
      ...
      function modalTabGroups() {
        ...
        for (var key in window.CookieConsent.config.categories) {
          contentItems.push((0, _redom.el)('dl.ccm__tabgroup' + '.' + key + (window.CookieConsent.config.categories[key].checked ? '.checked-5jhk' : ''), {
            'data-category': key
          }, (0, _redom.el)('dt.ccm__tab-head', _Language.default.getTranslation(window.CookieConsent.config.categories[key], window.CookieConsent.config.language.current, 'name'), (0, _redom.el)('a.ccm__tab-head__icon-wedge', {
            href: '#',
            tabindex: 0,
            title: '(Un)check'
          }, (0, _redom.el)(function () {
    ...
    value: function addEventListeners(elements) {
      ...
      var _iterator3 = _createForOfIteratorHelper(buttonConsentRefuse),
        _step3;
      try {
